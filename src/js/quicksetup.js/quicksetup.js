...
var g_quicksetup_old_wifiBasicData = [];
var g_quicksetup_old_wifiSecurityData = [];
                    ...
                    if (returnData.type == 'response') {
                        ...
                        if (returnData.response.hash == hashData) {
                            ...
                            if (rets.type == 'response') {
                                var temp = rets.response.Ssids.Ssid;
                                g_quicksetup_wifiSecurityData.WifiWpapsk = temp.WifiWpapsk;
                                g_quicksetup_wifiSecurityData.WifiWepKey1 = temp.WifiWepKey1;
                                g_quicksetup_wifiSecurityData.WifiWepKey2 = temp.WifiWepKey2;
                                g_quicksetup_wifiSecurityData.WifiWepKey3 = temp.WifiWepKey3;
                                g_quicksetup_wifiSecurityData.WifiWepKey4 = temp.WifiWepKey4;
                            }
                        }
                    }
                }, {
                        ...
                        if (returnData.response.hash == hashData) {
                            ...
                            if (rets.type == 'response') {
                                ...
                                $(g_quicksetup_wifiBasicData).each( function(i) {
                                    g_quicksetup_wifiBasicData[i].WifiWpapsk = secretKeyArray[i].WifiWpapsk;
                                    g_quicksetup_wifiBasicData[i].MixWifiWpapsk = secretKeyArray[i].MixWifiWpapsk;
                                    g_quicksetup_wifiBasicData[i].WifiWepKey1 = secretKeyArray[i].WifiWepKey1;
                                    g_quicksetup_wifiBasicData[i].WifiWepKey2 = secretKeyArray[i].WifiWepKey2;
                                    g_quicksetup_wifiBasicData[i].WifiWepKey3 = secretKeyArray[i].WifiWepKey3;
                                    g_quicksetup_wifiBasicData[i].WifiWepKey4 = secretKeyArray[i].WifiWepKey4;
                                });
                            }
                        }
                    }
...
function showData(data) {
    ...
    g_backup_ssid_name = data.WifiSsid;
...
function quicksetup_initPageData() {
    ...
    if(g_auto_update_enable == '1'){
        if (g_setup_wizard_page == '1') {
            $('input[name="update_selection"]').eq(0).attr('checked', true);
        } else {
            if (g_auto_update_ret.auto_update == '1') {
                $('input[name="update_selection"]').eq(0).attr('checked', true);
            } else {
                $('input[name="update_selection"]').eq(1).attr('checked', true);
            }
        }
...
function quicksetup_postData_wifi() {
    ...
    getAjaxData('api/wlan/basic-settings', function($xml) {
        var ret = xml2object($xml);
        if (ret.type == 'response') {
            g_quicksetup_old_wifiBasicData = ret.response; 
        }
    }, {
        sync: true
    });
    getAjaxData('api/wlan/security-settings', function($xml) {
        var ret = xml2object($xml);
        if (ret.type == 'response') {
            g_quicksetup_old_wifiSecurityData = ret.response;
            if (true == g_scarm_login) {
                var scram = CryptoJS.SCRAM();
                var wifiNonce = scram.nonce().toString();
                var wifiSalt = scram.nonce().toString();
                ...
                saveAjaxData('api/user/pwd', postXml, function($xml) {
                    ...
                    if (returnData.type == 'response') {
                        ...
                        if (returnData.response.hash == hashData) {
                            ...
                            if (rets.type == 'response') {
                                var temp = rets.response.Ssids.Ssid;
                                g_quicksetup_old_wifiSecurityData.WifiWpapsk = temp.WifiWpapsk;
                                g_quicksetup_old_wifiSecurityData.WifiWepKey1 = temp.WifiWepKey1;
                                g_quicksetup_old_wifiSecurityData.WifiWepKey2 = temp.WifiWepKey2;
                                g_quicksetup_old_wifiSecurityData.WifiWepKey3 = temp.WifiWepKey3;
                                g_quicksetup_old_wifiSecurityData.WifiWepKey4 = temp.WifiWepKey4;
                            }
                        }
                    }
                }, {
    ...
    if((g_quicksetup_old_wifiBasicData.WifiSsid == g_quicksetup_wifiBasicData[0].WifiSsid) && (g_quicksetup_old_wifiSecurityData.WifiWepKey1 == g_quicksetup_wifiBasicData[0].WifiWepKey1) && (g_quicksetup_old_wifiSecurityData.WifiWpapsk == g_quicksetup_wifiBasicData[0].WifiWpapsk )){
        return;
    }
...
function quicksetup_postData_wifiMultiSSID() {
    ...
    if (g_backup_ssid_name == g_quicksetup_wifiBasicData[0].WifiSsid && enpstring == '') {
        return;
    }
    var enptype = false;
    if(enpstring != '') {
...
function quicksetup_postDataSetupwizard() {
    if(g_setup_wizard_page == '1') {
        g_quicksetup_nochangepwd_saveDataOK = true;
        var request_info = {
...
function quicksetup_postData() {
    if(g_auto_update_enable == '1'){
        ...
        saveAjaxData('api/online-update/autoupdate-config', xmlstr_autoUpdate, function($xml) {
            var ret = xml2object($xml);
            if (ret.type == 'response') {
                quicksetup_postDataSetupwizard();
            } else {
                g_quicksetup_saveDataOK = false;
                g_quicksetup_nochangepwd_saveDataOK = false;
            }
...
function quicksetup_bindButtonClick() {
    ...
    $("#modifyWlanPswOption_w1 input").click( function() {
        if(true == $('#WlanPsw_check_w1').get(0).checked) {
    ...
    $("#showPswForW1").click( function() {
        if(true == $('#showPswForW1').get(0).checked) {
    ...
    $("#modifyWlanPswOption_w2 input").click( function() {
        if(true == $('#WlanPsw_check_w2').get(0).checked) {
    ...
    $("#showPswForW2").click( function() {
        if(true == $('#showPswForW2').get(0).checked) {
...
$(document).ready( function() {
    $('#WlanPsw_check_w1').get(0).checked = false ;
    $('#WlanPsw_check_w2').get(0).checked = false ;
    $('#showPswForW1').get(0).checked = false ;
    $('#showPswForW2').get(0).checked = false ;
