    ...
    if (plmnList.length > 0) {
        ...
        getAjaxData('operator.cgi', function($xml) {
            ...
            if ('response' == plmn_ret.type)
                ext_operator = plmn_ret.response
        }, {
            sync: true
        });
        $.each(plmnList, function(n, value) {
            if(ext_operator.Numeric == value.Numeric) {
                if (typeof(ext_operator.FullName) != 'undefined' &&
                ext_operator.FullName.length > 0)
                    value.FullName = ext_operator.FullName;
                if (typeof(ext_operator.ShortName) != 'undefined' &&
                ext_operator.ShortName.length > 0)
                    value.ShortName = ext_operator.ShortName;
                if (typeof(value.FullName) == 'undefined' ||
                value.FullName.length == 0)
                    value.FullName = value.ShortName;
                if (typeof(value.ShortName) == 'undefined' ||
...
function initBandSel() {
    ...
    if (g_lte_bands == "7FFFFFFFFFFFFFFF") {
        $('#LTE_All').attr('checked', true);
        $('#LTE_B1').attr('checked', false);
        $('#LTE_B3').attr('checked', false);
        $('#LTE_B7').attr('checked', false);
        $('#LTE_B8').attr('checked', false);
        $('#LTE_B20').attr('checked', false);
        $('#LTE_B38').attr('checked', false);
        $('#LTE_B40').attr('checked', false);
        ...
        $('#LTE_All').attr('checked', false);
        var lbm = parseInt(g_lte_bands, 16);
        $('#LTE_B1').attr('checked', (lbm & lte_band_1) != 0);
        $('#LTE_B3').attr('checked', (lbm & lte_band_3) != 0);
        $('#LTE_B7').attr('checked', (lbm & lte_band_7) != 0);
        $('#LTE_B8').attr('checked', (lbm & lte_band_8) != 0);
        $('#LTE_B20').attr('checked', (lbm & lte_band_20) != 0);
        $('#LTE_B38').attr('checked', BitwiseAndLarge(lbm, lte_band_38) != 0);
        $('#LTE_B40').attr('checked', BitwiseAndLarge(lbm, lte_band_40) != 0);
    ...
    if (g_umts_gsm_bands == "3FFFFFFF") {
        $('#UMTS_GSM_All').attr('checked', true);
        $('#UMTS_B1').attr('checked', false);
        $('#UMTS_B8').attr('checked', false);
        $('#GSM_850').attr('checked', false);
        $('#GSM_900').attr('checked', false);
        $('#GSM_1800').attr('checked', false);
        $('#GSM_1900').attr('checked', false);
        ...
        $('#UMTS_GSM_All').attr('checked', false);
        var ugbm = parseInt(g_umts_gsm_bands, 16);
        $('#UMTS_B1').attr('checked', (ugbm & umts_band_1) != 0);
        $('#UMTS_B8').attr('checked', BitwiseAndLarge(ugbm, umts_band_8) != 0);
        $('#GSM_850').attr('checked', (ugbm & gsm_band_850) != 0);
        $('#GSM_900').attr('checked', (ugbm & gsm_band_900) != 0);
        $('#GSM_1800').attr('checked', (ugbm & gsm_band_1800) != 0);
        $('#GSM_1900').attr('checked', (ugbm & gsm_band_1900) != 0);
...
function setting_dialup_enable(){   
    ...
    if(onlteenable){
        ...
        if(g_setting_netWork.NetworkMode == 0){
            $('#net_lte_enable').attr('checked', true);
        } else {
            $('#net_lte_enable').attr('checked', false);
        }
        ...
        $('#mobile_network_note').hide();
        if(g_setting_netWork.NetworkMode == 0){
            $('#net3gwork').attr('checked', true);
        } else {
            $('#net3gwork').attr('checked', false);
        }
