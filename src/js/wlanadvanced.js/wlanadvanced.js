    ...
    if( null != g_featureSwitch && DOUBLE_CHIP != g_featureSwitch.isdoublechip) {
        getAjaxData(strUrl, function($xml) {
            ...
            if(($.browser.msie) && ($.browser.version == 6.0)) {
                ...
                $('#select_WifiAutooffTime').val(g_wlan_dataInfo.Wifiofftime);
                //set wifi bandwith
                if( "0" != g_wlan_dataInfo.wifibandwidth && "20" != g_wlan_dataInfo.wifibandwidth && "40" != g_wlan_dataInfo.wifibandwidth ) {
                    setTimeout( function() {
        ...
        getAjaxData(strUrl, function($xml) {
            ...
            $(g_wlan_dataInfo_ex).each( function(i) {
                ...
                if( (g_wlan_dataInfo_ex[i].WifiMode != "a/n" || g_wlan_dataInfo_ex[i].WifiMode != "a" || g_wlan_dataInfo_ex[i].WifiMode != "a/n/ac") && (is_24G_first == true) ) {
                    ...
                    if( "0" != g_wlan_dataInfo_ex[i].wifibandwidth && "20" != g_wlan_dataInfo_ex[i].wifibandwidth && "40" != g_wlan_dataInfo_ex[i].wifibandwidth ) {
                        setTimeout( function() {
...
$(document).ready( function() {
    ...
    if (null != g_featureSwitch) {
        if(WIFI_AUTOCOUNTRY_ON == g_featureSwitch.wifiautocountry_enabled) {
            $("#autoCountry").show();
        } else {
            $("#autoCountry").hide();
        }
