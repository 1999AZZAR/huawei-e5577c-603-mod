...
function initPage() {
    getAjaxData('api/security/firewall-switch', function($xml) {
        ...
        if (ret.type == 'response')
        {
            ...
            $('#checkbox_FirewallMainSwitch').attr('checked', (g_firewallSwitchData.FirewallMainSwitch == 1));
            $('#checkbox_FirewallIPFilterSwitch').attr('checked', (g_firewallSwitchData.FirewallIPFilterSwitch == 1));
            $('#checkbox_FirewallWanPortPingSwitch').attr('checked', (g_firewallSwitchData.FirewallWanPortPingSwitch == 0));
            $('#checkbox_urlfilter').attr('checked', (g_firewallSwitchData.firewallurlfilterswitch == 1));
            if(g_module.fw_macfilter_enabled)
            {
                $('#checkbox_firewallmacfilterswitch').attr('checked', (g_firewallSwitchData.firewallmacfilterswitch == 1));
            }
            checked_ck();
        }
    });
