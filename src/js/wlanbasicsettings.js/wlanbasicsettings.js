                ...
                if (returnData.type == 'response') {
                    ...
                    if (returnData.response.hash == hashData) {
                        ...
                        if (rets.type == 'response') {
                            ...
                            g_wlan_securityData_old.WifiWpapsk = temp.WifiWpapsk;
                            g_wlan_securityData_old.WifiWepKey1 = temp.WifiWepKey1;
                            g_wlan_securityData_old.WifiWepKey2 = temp.WifiWepKey2;
                            g_wlan_securityData_old.WifiWepKey3 = temp.WifiWepKey3;
                            g_wlan_securityData_old.WifiWepKey4 = temp.WifiWepKey4;
                        }
                    }
                }
            }, {
...
function showEditData() {
    ...
    if(null != g_wifiFeatureSwitch && (g_wifiFeatureSwitch.doubleap5g_enable == 0) && (g_wifiFeatureSwitch.maxapnum == 2) && (g_wifiFeatureSwitch.isdoublechip == 0) && (g_editIndex != 0) && (g_wifiFeatureSwitch.wifi5g_enabled == 1) && (g_wlanInfo.WifiMode == "a/n" || g_wlanInfo.WifiMode == "a/n/ac")) {
...
function wlanbasicsettings_showPassword(str) {
    ...
    if(cbValue) {
        $('#check_wpa_psk_02').attr('checked', true);
        $('#check_wpa_psk').attr('checked', true);
    } else {
        $('#check_wpa_psk').attr('checked', false);
        $('#check_wpa_psk_02').attr('checked', false);
    }
...
function fourSsid_postData(doNotshowDialogFlag) {
    ...
    if(null != g_wifiFeatureSwitch && (g_wifiFeatureSwitch.doubleap5g_enable == 0) && (g_wifiFeatureSwitch.maxapnum == 2) && (g_wifiFeatureSwitch.isdoublechip == 0) && (g_doubleSSID == 1) && (g_wifiFeatureSwitch.wifi5g_enabled == 1) && (g_wlanInfo.WifiMode == "a/n" || g_wlanInfo.WifiMode == "a/n/ac")) {
        showInfoDialog(IDS_5G_doubleSsid, false, refresh);
    }
    var errorFlag = false;
